...
![Build Status](https://travis-ci.org/Rukenshia/graw.svg?branch=master)
![Version: 1.2.0](https://img.shields.io/badge/version-1.2.0-brightgreen.svg)
[![GoDoc](https://godoc.org/github.com/Rukenshia/graw?status.svg)](https://godoc.org/github.com/Rukenshia/graw)

    go get github.com/Rukenshia/graw
...
[api handle from the reddit package](https://godoc.org/github.com/Rukenshia/graw/reddit)
and a tell it what events you want to subscribe to; graw will take care of the
rest. See the [godoc](https://godoc.org/github.com/Rukenshia/graw) and
